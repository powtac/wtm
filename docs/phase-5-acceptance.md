...
| Public release | v0.4.3 is public with DMG, SHA-256 manifest, SPDX SBOM, build metadata, and an artifact attestation tied to release run `34045354962` |
...
| Accessibility | CI UI smoke and native accessibility-tree inspection pass; actual VoiceOver output verification is not established |
...
review. REQUIREMENTS.md still defines VoiceOver and trademark work as release gates;
the backlog classification above does not by itself close those normative requirements.
